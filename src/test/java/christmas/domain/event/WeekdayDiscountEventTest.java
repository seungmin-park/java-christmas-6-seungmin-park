...
class WeekdayDiscountEventTest {
    ...
    void returnTrueWeekdayDiscountEventSatisfiedOrder() {
        //given
        List<DayOfWeek> weekday = DayOfWeekGroup.WEEKDAY.getDayOfWeeks();
        MenuType discountMenuType = MenuType.DESSERT;
        WeekdayDiscountEvent weekdayDiscountEvent = new WeekdayDiscountEvent(weekday, discountMenuType);
